...
REPLACEMENTS = [
    ("from backend_overlay.app import rest", "from aw_server import rest"),
    ("from backend_overlay.app.config import", "from aw_server.config import"),
    ("from backend_overlay.app.custom_static import", "from aw_server.custom_static import"),
    ("from backend_overlay.app.log import", "from aw_server.log import"),
    ("from backend_overlay.app.server import", "from aw_server.server import"),
    ("from backend_overlay.api import", "from aw_server.api import"),
    ("from backend_overlay.exceptions import", "from aw_server.exceptions import"),
    ("from backend_overlay.query.exceptions import", "from aw_query.exceptions import"),
    ("from backend_overlay.query import query2", "from aw_query import query2"),
    ("from backend_overlay.shared import schema", "from aw_core import schema"),
    ("from backend_overlay.shared.config import", "from aw_core.config import"),
    ("from backend_overlay.shared.dirs import", "from aw_core.dirs import"),
    ("from backend_overlay.shared.log import", "from aw_core.log import"),
    ("from backend_overlay.shared.models import", "from aw_core.models import"),
    ("from backend_overlay.storage import Datastore, get_storage_methods", "from aw_datastore import Datastore, get_storage_methods"),
    ("from backend_overlay.storage import get_storage_methods", "from aw_datastore import get_storage_methods"),
    ("from backend_overlay.transform import heartbeat_merge", "from aw_transform import heartbeat_merge"),
    ("backend_overlay.browser.", "aw_server."),
    ("backend_overlay.", "aw_server."),
