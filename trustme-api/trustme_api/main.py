...
from trustme_api.app.config import config
from trustme_api.app.server import _start
from trustme_api.shared.log import setup_logging
from trustme_api.storage import get_storage_methods
...
def main():
    ...
    # at the path specified by trustme_api.shared.log.get_log_file_path().
    # We probably want
