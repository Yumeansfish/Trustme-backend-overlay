...
from backend_overlay.browser.canonical.strategy import PERSISTED_UNIT_KINDS
from backend_overlay.browser.dashboard.scope_service import DashboardSummaryScope
from backend_overlay.browser.settings.schema import normalize_settings_data
from backend_overlay.browser.snapshots.categories import (
    compile_category_rules,
    normalize_category_name,
)
from backend_overlay.browser.snapshots.models import (
    PeriodBound,
    SummarySegment,
    datetime_to_ms,
)
...
from backend_overlay.browser.snapshots.scope import build_summary_snapshot_scope_key
from backend_overlay.browser.snapshots.segments import (
