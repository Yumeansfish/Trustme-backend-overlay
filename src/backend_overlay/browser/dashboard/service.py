...
from backend_overlay.browser.dashboard.checkins_service import build_checkins_payload
from backend_overlay.browser.dashboard.details_service import build_dashboard_details
...
def build_summary_snapshot_response(
    *,
    ...
    from backend_overlay.browser.snapshots.summary_service import build_summary_snapshot_from_scope
