...
CHECKIN_TIMELINE_LOOKAROUND = timedelta(minutes=5)
...
def _build_session(file_date: str, index: int, pairs: Sequence[CheckinPair]) -> Dict[str, Any]:
    ...
    timeline_start = started_at - CHECKIN_TIMELINE_LOOKAROUND
    timeline_end = started_at + CHECKIN_TIMELINE_LOOKAROUND
