...
from backend_overlay.app.custom_static import get_custom_static_blueprint
from backend_overlay.app.log import FlaskLogHandler
from backend_overlay.browser.snapshots.scheduler import start_dashboard_summary_warmup
from backend_overlay.storage import Datastore, get_storage_methods
...
# Only to be called from backend_overlay.main function!
def _start(
    storage_method,
    host: str,
    port: int,
